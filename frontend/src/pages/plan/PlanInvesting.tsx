...
export function PlanInvestingPage() {
  ...
  return (
    <Stack spacing={2}>
      <PlanCard title="Investing strategy" actions={<Button component={RouterLink} to="/plan">Back to dashboard</Button>}>
        <BulletList items={planJson.investing_strategy?.bullets} />
      </PlanCard>
    </Stack>
  )
}
